...
export async function onRequestPost(context){
  ...
  const saved = await ghWrite('signup-requests', reqList, reqSha);
  ...
  await sendEmail(resendKey, ADMIN_EMAIL,
    ...
    `<div style="font-family:sans-serif;max-width:480px">
      ...
      <a href="https://pivot-eb5.pages.dev" style="background:#1758a8;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;display:inline-block;margin-top:10px">Open Dashboard</a>
    </div>`
  );
