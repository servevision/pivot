...
const ALLOWED   = ['sheets','salary','holiday','expenses','employees','signup-requests','leave-requests','employee-logins','workrecord-cache','hsim-employees','hsim-signup-requests','hsim-leave-requests','hsim-employee-logins','hsim-attendance','hsim-settings','password-reset-requests','hsim-password-reset-requests','sales','clients','invoices','company-settings'];
...
export async function onRequestGet(context){
  ...
  return respond(content??(['sheets','expenses','employees','signup-requests','leave-requests','workrecord-cache','hsim-employees','hsim-signup-requests','hsim-leave-requests','hsim-attendance','password-reset-requests','hsim-password-reset-requests','sales','clients','invoices'].includes(table)?[]:{}) );
}
